...
/*
 * Credits: Cozette, bdf2c
 *
 * This was taken from fs-os/fs-os, for more information, consult there.
 *
 * Each item of the char idx is a 8px row of that char, represented by
